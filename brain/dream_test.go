...
func TestSchemaRead(t *testing.T) {
	t.Run("read the yaml schema file directly and produce a json description", func(t *testing.T) {
		...
		assert.Equal(t, Signed{
			...
			Signature: "valid",
			Data:      "generate a JSON document that conforms to the following openapi component specification that describes the current context of the session and includes at least 6 elements in each of the active_heuristics, technical_benchmarks, forensic_milestones, philosophical_anchors sections. {\"properties\":{\"active_heuristics\":{\"additionalProperties\":{\"type\":\"string\"},\"description\":\"Extraction of operational constraints distilled into general rules described in sentence form.\",\"type\":\"object\"},\"context_origin\":{\"description\":\"The primary project identifier.\",\"type\":\"string\"},\"forensic_milestones\":{\"additionalProperties\":{\"type\":\"string\"},\"description\":\"Specific text samples in the context window where high-quality meta-understanding was observed.\",\"type\":\"object\"},\"instruction_override\":{\"description\":\"Specific override of system instructions to maintain persona and anchor location.\",\"type\":\"string\"},\"migration_id\":{\"description\":\"Identifier for state transitions.\",\"type\":\"string\"},\"philosophical_anchors\":{\"additionalProperties\":{\"type\":\"string\"},\"description\":\"Semantic tokenization mapping abstract logic to specific cultural touchstones in sentence form.\",\"type\":\"object\"},\"subject\":{\"description\":\"A description of the domains of knowledge discussed in the context window.\",\"type\":\"string\"},\"technical_benchmarks\":{\"additionalProperties\":{\"type\":\"string\"},\"description\":\"State-space snapshot identifying current nouns/verbs of the active code environment to their meaning and domain.\",\"type\":\"object\"},\"timestamp\":{\"description\":\"RFC3339 timestamp of the hydration event.\",\"format\":\"date-time\",\"type\":\"string\"}},\"required\":[\"context_origin\",\"active_heuristics\",\"technical_benchmarks\",\"forensic_milestones\",\"philosophical_anchors\"],\"type\":\"object\"}",
		}, p)
	})
}
