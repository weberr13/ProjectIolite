...
func (r *GeminiResponse) CoT(sv brain.SignVerifier, quiet ...bool) []brain.Signed {
	if r.cot == nil {
...
func (r *GeminiResponse) Thought(quiet ...bool) brain.Signed {
	if len(quiet) > 0 && quiet[0] {
		t := *r.Text()
		t.Data64 = ""
		return t
